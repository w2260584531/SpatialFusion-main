...
def construct_graph_by_feature(adata_omics1, k=20, mode= "connectivity", metric="correlation", include_self=False):
    ...
    adata_omics1.obsm['adj_feat']=feature_graph_omics1
